...
class Company {
  ...
  // filtered get request (by name, minEmployees, maxEmployees)
  static async filteredGet(name, minEmployees, maxEmployees) {
    ...
    // add minEmployees filter if provided
    if (minEmployees) {
